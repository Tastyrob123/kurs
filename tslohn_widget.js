...
(function(){
  ...
  #tslohn .tslohn-guide{position:absolute;top:-9px;bottom:-9px;width:0;border-left:1.5px dashed rgba(255,255,255,.34);opacity:0;transition:opacity .5s ease .5s}
  #tslohn.on .tslohn-guide{opacity:1}
  #tslohn .tslohn-guide__tag{position:absolute;top:-24px;left:50%;transform:translateX(-50%);font-size:.6rem;font-weight:600;letter-spacing:.1em;text-transform:uppercase;color:rgba(255,255,255,.5);white-space:nowrap}
  ...
  #tslohn .tslohn-lg b{color:#fff;font-weight:600;margin-left:2px}
  #tslohn .tslohn-lg s{color:rgba(255,255,255,.4);font-size:.72rem;text-decoration:none;margin-left:4px}
    ...
    root.innerHTML=
      ...
      +'<div class="tslohn-break">'
        ...
        +'<div class="tslohn-track">'+segHTML
          +'<div class="tslohn-guide" data-left="'+baseW+'"><span class="tslohn-guide__tag">100&thinsp;% Brutto</span></div>'
        +'</div>'
