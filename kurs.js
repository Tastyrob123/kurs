...
/* ============================================================
   ...
   ============================================================ */
(function(){
  var IMG="https://files.catbox.moe/agqjws.png"; /* 3-Laptop-Cover Rezepturen (Meine Rezepte.png) */
  var LOGO="https://files.catbox.moe/au80tp.png";
...
(function(){
  ...
  var CSS=`
  #tsd4{width:min(1000px,95vw);margin:-34px auto 40px;font-family:-apple-system,BlinkMacSystemFont,"SF Pro Display","Helvetica Neue",sans-serif;color:#fff;opacity:0;transform:translateY(20px);transition:opacity .8s cubic-bezier(.16,1,.3,1),transform .9s cubic-bezier(.16,1,.3,1)}
  ...
  var KACHELN=[
    ...
    { kachel_id:'db4_zutaten', kachel_name:'Zutaten', ist_produkt_kachel:true,
      ...
      objekt_varianten:[
        ...
        { name:'Feige',         wert:55,  img:'https://tastyrob123.github.io/kurs/img/zutaten/feige.jpg' },
        { name:'Spinat',        wert:60,  img:'https://tastyrob123.github.io/kurs/img/zutaten/spinat.jpg' },
        { name:'Aubergine',     wert:160, img:'https://tastyrob123.github.io/kurs/img/zutaten/aubergine.jpg' },
        { name:'Parmesan',      wert:50,  img:'https://tastyrob123.github.io/kurs/img/zutaten/parmesan.jpg' },
        { name:'Ingwer',        wert:25,  img:'https://tastyrob123.github.io/kurs/img/zutaten/ingwer.jpg' },
        { name:'Rote Bete',     wert:130, img:'https://tastyrob123.github.io/kurs/img/zutaten/rote-bete.jpg' },
        { name:'Hähnchenbrust', wert:200, img:'https://tastyrob123.github.io/kurs/img/zutaten/haehnchenbrust.jpg' },
